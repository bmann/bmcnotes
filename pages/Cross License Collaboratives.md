alias:: XLC
link:: https://xlcollaborative.com/
author:: [[Kyle Mitchell]]
tags:: #licensing

- [[Cross License Collaboratives Blog Post]]
- Full License Text https://xlcollaborative.com/agreement/1.0.0-pre.7
	- ## Purpose
	...
	- ## Contributors
		...
		- To apply to become a contributor, a candidate must send the following to an existing contributor:
			- their [address](https://xlcollaborative.com/agreement/1.0.0-pre.7#addresses) for [communication](https://xlcollaborative.com/agreement/1.0.0-pre.7#communications)
			- their [instructions](https://xlcollaborative.com/agreement/1.0.0-pre.7#payment-instructions) for [payment](https://xlcollaborative.com/agreement/1.0.0-pre.7#payments)
		...
		- ### Admission
			- For a candidate to become a contributor, an existing contributor must follow each of these steps, one after another, in order:
				- [circulate](https://xlcollaborative.com/agreement/1.0.0-pre.7#circulating-messages) the candidate’s complete application
				- secure [majority approval](https://xlcollaborative.com/agreement/1.0.0-pre.7#majority) in favor of their application
				- provide the candidate complete copies of all sublicenses still in effect
				- receive and [circulate](https://xlcollaborative.com/agreement/1.0.0-pre.7#circulating-messages) a message from the candidate confirming receipt of, and approving, all sublicenses still in effect
				- [circulate](https://xlcollaborative.com/agreement/1.0.0-pre.7#circulating-messages) a current list of all contributor [addresses](https://xlcollaborative.com/agreement/1.0.0-pre.7#addresses) and [payment instructions](https://xlcollaborative.com/agreement/1.0.0-pre.7#payment-instructions), including the new contributor’s
		- ### Resignation
			- Any contributor may resign at any time by [circulating](https://xlcollaborative.com/agreement/1.0.0-pre.7#circulating-messages) a message of resignation. When a contributor resigns, all cross licenses to that contributor end, but their cross licenses to other contributors, as well as any sublicenses they have given, continue.
	- ## Cross Licenses
		- ### Copyright
		...
		- ### Sublicensing
			- Any contributor may give a sublicense within thirty calendar days of securing [majority approval](https://xlcollaborative.com/agreement/1.0.0-pre.7#majority). When [soliciting votes](https://xlcollaborative.com/agreement/1.0.0-pre.7#soliciting-votes) for a sublicense, a contributor must [circulate](https://xlcollaborative.com/agreement/1.0.0-pre.7#circulating-messages):
